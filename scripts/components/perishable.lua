...
function Perishable:Perish()
    ...
    if self.inst:IsValid() and self.onperishreplacement ~= nil then
        ...
        if goop ~= nil then
			...
			if owner ~= nil and owner:HasTag("composter") and self.onperishreplacement == "spoiled_food" and owner:HasTag("guano") then
				goop:Remove()
				goop = SpawnPrefab("guano")
			end
			if owner ~= nil and owner:HasTag("composter") and self.onperishreplacement == "spoiled_food" and owner:HasTag("poop") then
				goop:Remove()
